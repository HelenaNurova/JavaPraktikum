...
public class Praktikum {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                printAllExpenses(expenses);//  метод printAllExpenses - напечатать расходы за неделю

            } else if (command == 5) {

                // Печать  максимальной траты:
    ...
    public static double saveExpense(Scanner scanner, double moneyBeforeSalary, double[] expenses) {
        /*  метод saveExpense, который будет сохранять значение расходов пользователя.
    ...
    public static double findMaxExpense(double[] expenses) { // findMaxExpense — возвращает значение максимальной траты
        double maxExpense = 0;
        for (int i = 0; i < expenses.length; i++) {
